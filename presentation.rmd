...
-   Notice that Rmarkdown generates the graph from python code. However, the command `{r,eval=FALSE}eval = FALSE` prevents the code from being shown.
...
-   Cheatsheet
    -   <https://rmarkdown.rstudio.com/lesson-15.HTML> \## Alternatives
-   Quarto
